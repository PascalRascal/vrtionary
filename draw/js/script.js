var lc,
    ...
    timer = 30, 
    x,
    words = ['cat', 'rhino', 'hand', 'house', 'computer', 'man', 'woman', 'love', 'hate',
         'water', 'rain', 'storm', 'tornado', 'hurricane', 'planet', 'candy',
         'phone', 'laptop', 'chips', 'soda', 'poptart', 'sleep', 'ohio', 'school', 'pencil', 'pen', 'foot',
         'nose', 'Middle East', 'bacteria', 'door', 'television', 'money', 'chair', 'elephant',
         'scissors', 'point', 'glue', 'star', 'tree', 'airplane', 'bird', 'superhero', 'superman', 'basketball',
         'baseball', 'football', 'soccer', 'cricket', 'japan', 'mouth', 'tooth', 'glasses', 'hat',
         , 'jar', , 'smile', 'cheek', 'jail', 'cop', 'ear', 'drum', 'guitar',
